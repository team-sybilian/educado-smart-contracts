...
contract User {
    ...
    event NewUserEntry(bytes32 _checksum, string _name, string _class, uint _timestamp, address indexed _setBy);
    /**
     * Add a new entry to the ledger.
     *
     * Example: 0x9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08, "Name", "Class", "1572506961"
     **/
    function createUserEntry(bytes32 _checksum, string memory _name, string memory _class, uint _timestamp) public {
        ...
        userMapping[_checksum].class = _class;
    ...
    function readUserEntry(bytes32 _checksum) public view returns(bytes32, string memory, string memory, uint, address) {
        ...
        // Return entry.
        return(userMapping[_checksum].checksum, userMapping[_checksum].name, userMapping[_checksum].class,
