...
contract Document {
     ...
     **/
    function createDocumentEntry(bytes32 _checksum, string memory _name, string memory _comment, uint _timestamp) public {
     ...
     **/
    function readDocumentEntry(bytes32 _checksum) public view returns(bytes32, string memory, string memory, uint, address) {
